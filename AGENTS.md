...
1. **Run Pre-commit Hooks**
   ...
   - **Important**: Respect the max line length configured in the repository's tooling (e.g., `.flake8`, `pyproject.toml`, or other formatter configs). Do not assume or hard-code a specific numeric limit.
