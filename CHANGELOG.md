...
* Isolated rate-limit and audit activity from trusted proxies that omit a valid
  forwarded client identity, without promoting infrastructure addresses to
  actionable client IPs.
