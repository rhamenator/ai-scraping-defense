...
os.environ.setdefault("HONEYPOT_LOG_FILE", os.path.join(test_logs_dir, "test_honeypot.log"))
os.environ.setdefault("BLOCK_LOG_FILE", os.path.join(test_logs_dir, "test_block_events.log"))
os.environ.setdefault("CAPTCHA_SUCCESS_LOG", os.path.join(test_logs_dir, "test_captcha_success.log"))
os.environ.setdefault("DECISIONS_DB_PATH", os.path.join(test_data_dir, "test_decisions.db"))
