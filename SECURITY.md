...
2. **Preferred:** Open a [private GitHub security advisory](https://github.com/rhamenator/ai-scraping-defense/security/advisories/new). If private reporting is unavailable, email **rhamenator@gmail.com**.
