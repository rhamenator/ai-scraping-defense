#!/bin/zsh
# api_security_test.zsh - Automated API security testing for macOS
#
# Usage: ./api_security_test.zsh <base_url> [openapi_spec_url]
...
for endpoint in "${API_ENDPOINTS[@]}"; do
    STATUS=$(curl -s -o /dev/null -w "%{http_code}" -H "Authorization: $INVALID_TOKEN" "$BASE_URL$endpoint" || echo "000")
